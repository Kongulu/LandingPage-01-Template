  ...
  return (
    <div className="mt-10 bg-white p-6 rounded-lg shadow-md border-t-4 border-primary">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <a href="https://bookmarkconverter.replit.app" className="block p-4 bg-gray-50 hover:bg-gray-100 rounded-lg border border-gray-200 transition-colors">
          <h3 className="font-medium text-gray-800 mb-1">Try Bookmark Converter</h3>
          <p className="text-gray-600 text-sm">Use our bookmark converter tool in its new dedicated project</p>
        </a>
