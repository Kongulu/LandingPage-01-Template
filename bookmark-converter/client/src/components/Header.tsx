      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          <div className="flex items-center space-x-2">
            ...
            <span className="bg-gray-100 text-gray-600 text-xs px-2 py-1 rounded">Bookmark Converter</span>
          </div>
          <nav>
            <ul className="flex space-x-6">
              <li><a href="https://node12.com" className="text-gray-600 hover:text-primary">Main Site</a></li>
